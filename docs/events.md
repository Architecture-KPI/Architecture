...
Асинхронна доставка подій означає, що між комітом основної операції і обробкою підписниками є затримка. Система **тимчасово неконсистентна** — це [eventual consistency](consistency.md#eventual-consistency).

Детальніше про рівні консистентності, CAP theorem та вибір між strong і eventual — в [окремому документі](consistency.md).
